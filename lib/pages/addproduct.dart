...
import 'package:flutter_medical_ui/models/product.dart';
import 'package:flutter_medical_ui/pages/products.dart';
import 'package:flutter_medical_ui/services/databasehelper.dart';
...
class _ProductAddState extends State<ProductAdd> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          title: Text("Tuliskan Kendala Anda "),
        ),
        body: Column(
          children: <Widget>[
            Expanded(
                    ...
                    child: Form(
                        child: Column(
                          ...
                          TextFormField(
                            ...
                            decoration: const InputDecoration(
                                hintText: 'Tuliskan Alamat Anda',
                                labelText: 'Alamat'),
                          ),
                          TextFormField(
                            controller: descriptionController,
                            decoration: const InputDecoration(
                                hintText: 'Tuliskan Kendala Anda',
                                labelText: 'Kendala'),
                          ),
                          Row(
